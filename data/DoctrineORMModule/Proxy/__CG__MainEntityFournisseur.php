 ...
 */
class Fournisseur extends \Main\Entity\Fournisseur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Main\\Entity\\Fournisseur' . "\0" . 'idFourn', '' . "\0" . 'Main\\Entity\\Fournisseur' . "\0" . 'nomFourn', '' . "\0" . 'Main\\Entity\\Fournisseur' . "\0" . 'villeClient'];
        }
